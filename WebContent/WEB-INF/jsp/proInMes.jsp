    ...
    layui.use(['element','table','jquery', 'form','laydate', 'layer'], function(){
        ...
        form.on('submit(formDemo)', function(data){
          //  console.log(data.field);
            ...
            $.ajax({
                type : 'post',
                url : '${pageContext.request.contextPath}/Product_Staff.selRkpcInfo',
                ...
                success : function(data) {
                	...
                	if(data!=null){
	                	var get = data.split(",");
	                	var da = {
	                			入库批次ID:get[0],产品ID:changeToCode(get[1]),产品名称:get[2],入库数量:get[3],负责人ID:changeToCode(get[4]),入库时间:get[5],剩余数量:get[6]
	                	};
        ...
        form.on('submit(formDemo1)', function(data){
            ...
            $.ajax({
                type : 'post',
                url : '${pageContext.request.contextPath}/Product_Staff.selRkpcInfoviafzr',
                //设置contentType类型为json
                contentType : 'application/json;charset=utf-8',
                //json数据
                data :  JSON.stringify(da),
        ...
        form.on('submit(formDemo2)', function(data){
            ...
            $.ajax({
                type : 'post',
                url : '${pageContext.request.contextPath}/Product_Staff.selRkpcInfoviaTime',
                //设置contentType类型为json
                contentType : 'application/json;charset=utf-8',
                //json数据
                data :  JSON.stringify(da),
