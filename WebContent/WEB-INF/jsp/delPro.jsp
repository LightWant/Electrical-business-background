...
<div class="layui-fluid"> 
		...
		<form class="layui-form" action="" id="form1">
		  	  <div class="layui-form-item">
		  	  	<label class="layui-form-label" style="font-20px">库存销毁</label>
		  	  </div>
		  	 
			  <div class="layui-form-item">
					<label class="layui-form-label" id = "deslb" >产品名称</label>
...
layui.use(['form','layer'], function(){
  ...
  form.on('select(selMat)',function(data){
	  ...
	  $.ajax({
		  url:'${pageContext.request.contextPath}/Product_Staff.getRkpc',     
	      type :'post',       
  ...
  form.on('submit(formDemo)',function(data){
	  ...
	  $.ajax({
		  url:'${pageContext.request.contextPath}/Product_Staff.destroyRkpc',     
	      type :'post',       
	      contentType : 'application/json;charset=utf-8',
	      data:JSON.stringify(da),
		  success:function(res){  
