...
<head>
  ...
  <title>计划管理子系统员工</title>
  <link rel="stylesheet" href="layui/css/layui.css">
</head>
<body class="layui-layout-body">
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">计划管理子系统员工</div>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="javascript:;" id="wolkPlan">生产计划</a></dd>
  <!--           <dd><a href="">超链接</a></dd> -->
          </dl>
        </li>
        <li class="layui-nav-item">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="javascript:;" id="select">生产计划</a></dd>
          </dl>
        </li>
...
layui.use(['jquery','layer','element', 'form'], function(){
 /*  var element = layui.element; */
  ...
  element.init();
  $(document).on("click", "#wolkPlan", function() {
	 // console.log(document.getElementById("yuangongvalue").value);
	  $("iframe").attr("src",'${pageContext.request.contextPath}/WorkPlan', function(){
  ...
  $(document).on('click','#select',function() {
	  $("iframe").attr("src",'${pageContext.request.contextPath}/selectShengChanPlan', function(){
		  layui.use(['element','form'], function(){
	          var element = layui.element
	          , form = layui.form;
				form.render();
